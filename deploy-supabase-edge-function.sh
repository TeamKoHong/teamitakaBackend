...
echo ""
echo "✅ 배포 완료 후 테스트:"
echo "curl -X GET 'https://huwajjafqbfrcxkdfker.supabase.co/functions/v1/teamitaka-api/api/health'"
echo ""
echo "📧 이메일 인증 테스트:"
echo "curl -X POST 'https://huwajjafqbfrcxkdfker.supabase.co/functions/v1/teamitaka-api/api/auth/send-verification' \\"
