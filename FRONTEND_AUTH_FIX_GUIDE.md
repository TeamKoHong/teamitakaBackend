...
```
POST https://your-project-ref.supabase.co/functions/v1/teamitaka-api/api/auth/send-verification 401 (Unauthorized)
...
```javascript
// ❌ 현재 코드 (오류 발생)
const response = await fetch('https://your-project-ref.supabase.co/functions/v1/teamitaka-api/api/auth/send-verification', {
  method: 'POST',
  headers: {
...
```bash
curl -X POST 'https://your-project-ref.supabase.co/functions/v1/teamitaka-api/api/auth/send-verification' \
