...
router.get("/:project_id", authMiddleware, validateUUID('project_id'), projectController.getProjectById);
...
// ✅ 타임라인 CRUD
router.get("/:project_id/timeline", authMiddleware, validateUUID('project_id'), timelineController.getTimeline);
...
// ✅ 회의록 CRUD
router.get("/:project_id/meetings", authMiddleware, validateUUID('project_id'), meetingNotesController.getMeetingNotes);
router.get("/:project_id/meetings/:meeting_id", authMiddleware, validateUUID('project_id', 'meeting_id'), meetingNotesController.getMeetingNoteById);
...
// ✅ 팀원 조회/추가
router.get("/:project_id/members", authMiddleware, validateUUID('project_id'), memberController.getMembers);
...
router.post("/:project_id/posts", authMiddleware, validateUUID('project_id'), projectPostController.createPost);
