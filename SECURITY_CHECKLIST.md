...
### ⚠️ 즉시 수정 필요한 사항
- [x] **`env.supabase` 파일 삭제 또는 이동** (민감한 정보 포함)
- [x] **`vercel.json`에서 하드코딩된 정보 제거** (완료됨)
- [x] **Git 히스토리에서 민감한 정보 제거**
- [x] **Supabase Edge Functions에서 하드코딩된 시크릿 제거**
